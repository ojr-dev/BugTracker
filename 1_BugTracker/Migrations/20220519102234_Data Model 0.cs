...
{
    public partial class DataModel0 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectMembersId = table.Column<string>(type: "text", nullable: false),
                    ProjectsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BT_UserProject", x => new { x.ProjectMembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_BT_UserProject_AspNetUsers_ProjectMembersId",
                        column: x => x.ProjectMembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BT_UserProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientFirstName = table.Column<string>(type: "text", nullable: false),
                    RecipientLastName = table.Column<string>(type: "text", nullable: false),
                    RecipientEmail = table.Column<string>(type: "text", nullable: false),
                    IsVaid = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BT_UserProject_ProjectsId",
                table: "BT_UserProject",
                column: "ProjectsId");
